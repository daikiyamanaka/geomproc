...
void PoissonDiskSampling::sample(std::vector<Eigen::Vector3d> &points){
	...
	Eigen::Vector3d init_point = genRandomPoint();//Eigen::Vector3d(width_-2, height_-2, 0);
...
void PoissonDiskSampling::setCenter(Eigen::Vector3d center){
	center_ = center;
}
